/* separator.c generated by valac 0.38.2, the Vala compiler
...
enum  {
	...
	HSEPARATOR_LAST_PROPERTY
};
static GParamSpec* hseparator_properties[HSEPARATOR_LAST_PROPERTY];
...
enum  {
	...
	VSEPARATOR_LAST_PROPERTY
};
static GParamSpec* vseparator_properties[VSEPARATOR_LAST_PROPERTY];
