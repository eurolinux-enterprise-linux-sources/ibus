...
static void __lambda16_ (IBusEmojier* self, GtkEntryIconPosition icon_pos, GdkEvent* event);
static void ibus_emojier_hide_candidate_panel (IBusEmojier* self);
static void ___lambda16__gtk_entry_icon_release (GtkEntry* _sender, GtkEntryIconPosition p0, GdkEvent* p1, gpointer self);
static void __lambda17_ (IBusEmojier* self);
static void ___lambda17__gtk_widget_hide (GtkWidget* _sender, gpointer self);
static void __lambda18_ (IBusEmojier* self, guint i, guint b, guint s);
static void ibus_emojier_candidate_panel_select_index (IBusEmojier* self, guint index);
static void ___lambda18__ibus_emojier_candidate_clicked (IBusEmojier* _sender, guint index, guint button, guint state, gpointer self);
...
static void __lambda8_ (IBusEmojier* self, GtkListBox* box, GtkListBoxRow* gtkrow);
...
static void ___lambda8__gtk_list_box_row_activated (GtkListBox* _sender, GtkListBoxRow* row, gpointer self);
...
static gint __lambda9_ (const gchar* a, const gchar* b);
...
static void __lambda14_ (IBusEmojier* self);
...
static gboolean ___lambda7_ (IBusEmojier* self, GtkWidget* w, GdkEventButton* e);
static gboolean ____lambda7__gtk_widget_button_press_event (GtkWidget* _sender, GdkEventButton* event, gpointer self);
...
static gboolean _____lambda10_ (Block4Data* _data4_, GtkWidget* w, GdkEventButton* e);
static gboolean ______lambda10__gtk_widget_button_press_event (GtkWidget* _sender, GdkEventButton* event, gpointer self);
static gboolean _____lambda11_ (Block4Data* _data4_, GdkEventMotion* e);
...
static gboolean __lambda12_ (IBusEmojier* self);
static gboolean ___lambda12__gsource_func (gpointer self);
static gboolean ______lambda11__gtk_widget_motion_notify_event (GtkWidget* _sender, GdkEventMotion* event, gpointer self);
static void _vala_array_add9 (GtkLabel** * array, int* length, int* size, GtkLabel* value);
...
static gboolean __lambda5_ (IBusEmojierEListBox* self, GdkEventMotion* e);
static gboolean ___lambda5__gtk_widget_motion_notify_event (GtkWidget* _sender, GdkEventMotion* event, gpointer self);
static gboolean __lambda6_ (IBusEmojierEListBox* self, GdkEventCrossing* e);
...
static void ___lambda16__gtk_entry_icon_release (GtkEntry* _sender, GtkEntryIconPosition p0, GdkEvent* p1, gpointer self) {
	__lambda16_ ((IBusEmojier*) self, p0, p1);
}
...
static void ___lambda18__ibus_emojier_candidate_clicked (IBusEmojier* _sender, guint index, guint button, guint state, gpointer self) {
	__lambda18_ ((IBusEmojier*) self, index, button, state);
}
...
IBusEmojier* ibus_emojier_construct (GType object_type) {
	...
	g_signal_connect_object ((GtkEditable*) _tmp159_, "changed", (GCallback) ___lambda15__gtk_editable_changed, self, 0);
	_tmp160_ = self->priv->m_entry;
	g_signal_connect_object ((GtkEntry*) _tmp160_, "icon-release", (GCallback) ___lambda16__gtk_entry_icon_release, self, 0);
	...
	g_signal_connect_object ((GtkWidget*) self, "hide", (GCallback) ___lambda17__gtk_widget_hide, self, 0);
	g_signal_connect_object (self, "candidate-clicked", (GCallback) ___lambda18__ibus_emojier_candidate_clicked, self, 0);
...
static void ___lambda8__gtk_list_box_row_activated (GtkListBox* _sender, GtkListBoxRow* row, gpointer self) {
	__lambda8_ ((IBusEmojier*) self, _sender, row);
}
...
static void ibus_emojier_show_category_list (IBusEmojier* self) {
	...
	g_signal_connect_object ((GtkListBox*) _tmp19_, "row-activated", (GCallback) ___lambda8__gtk_list_box_row_activated, self, 0);
	n = (guint) 1;
...
static void ibus_emojier_show_arrow_buttons (IBusEmojier* self) {
	...
	g_object_ref_sink (_tmp0_);
	next_button = _tmp0_;
	g_signal_connect_object (next_button, "clicked", (GCallback) ___lambda13__gtk_button_clicked, self, 0);
	...
	prev_button = _tmp3_;
	g_signal_connect_object (prev_button, "clicked", (GCallback) ___lambda14__gtk_button_clicked, self, 0);
...
static gboolean ____lambda7__gtk_widget_button_press_event (GtkWidget* _sender, GdkEventButton* event, gpointer self) {
	gboolean result;
	result = ___lambda7_ ((IBusEmojier*) self, _sender, event);
	return result;
}
...
static gboolean ______lambda10__gtk_widget_button_press_event (GtkWidget* _sender, GdkEventButton* event, gpointer self) {
	gboolean result;
	result = _____lambda10_ (self, _sender, event);
	return result;
}
...
static gboolean ___lambda12__gsource_func (gpointer self) {
	gboolean result;
	result = __lambda12_ ((IBusEmojier*) self);
	return result;
}
...
static gboolean _____lambda11_ (Block4Data* _data4_, GdkEventMotion* e) {
	...
	_tmp25_ = g_timeout_add_full (G_PRIORITY_DEFAULT, (guint) 100, ___lambda12__gsource_func, g_object_ref (self), g_object_unref);
...
static gboolean ______lambda11__gtk_widget_motion_notify_event (GtkWidget* _sender, GdkEventMotion* event, gpointer self) {
	gboolean result;
	result = _____lambda11_ (self, event);
	return result;
}
...
static void ibus_emojier_show_candidate_panel (IBusEmojier* self) {
	...
	if (_tmp13_ != NULL) {
		...
		_tmp26_ = button;
		g_signal_connect_object ((GtkWidget*) _tmp26_, "button-press-event", (GCallback) ____lambda7__gtk_widget_button_press_event, self, 0);
	...
	n = 0;
	{
		...
		i = _tmp28_;
		{
			...
			while (TRUE) {
				...
				g_signal_connect_data ((GtkWidget*) _tmp80_, "button-press-event", (GCallback) ______lambda10__gtk_widget_button_press_event, block4_data_ref (_data4_), (GClosureNotify) block4_data_unref, 0);
				_tmp81_ = candidate_ebox;
				g_signal_connect_data ((GtkWidget*) _tmp81_, "motion-notify-event", (GCallback) ______lambda11__gtk_widget_motion_notify_event, block4_data_ref (_data4_), (GClosureNotify) block4_data_unref, 0);
				_tmp82_ = grid;
				...
				_vala_array_add9 (&self->priv->m_candidates, &self->priv->m_candidates_length1, &self->priv->_m_candidates_size_, _tmp89_);
...
static void ibus_emojier_enter_notify_disable_with_timer (IBusEmojier* self) {
	...
	_tmp2_ = g_timeout_add_full (G_PRIORITY_DEFAULT, (guint) 100, ___lambda19__gsource_func, g_object_ref (self), g_object_unref);
	...
	_ibus_emojier_m_favorite_annotations_size_ = ibus_emojier_m_favorite_annotations_length1;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp13_ = favorite;
				_tmp14_ = g_strdup (_tmp13_);
				_vala_array_add10 (&ibus_emojier_m_favorites, &ibus_emojier_m_favorites_length1, &_ibus_emojier_m_favorites_size_, _tmp14_);
				_g_free0 (favorite);
			}
		}
	}
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp26_ = g_strdup (_tmp25_);
				_vala_array_add11 (&ibus_emojier_m_favorite_annotations, &ibus_emojier_m_favorite_annotations_length1, &_ibus_emojier_m_favorite_annotations_size_, _tmp26_);
...
static gboolean ___lambda5__gtk_widget_motion_notify_event (GtkWidget* _sender, GdkEventMotion* event, gpointer self) {
	gboolean result;
	result = __lambda5_ ((IBusEmojierEListBox*) self, event);
	return result;
}
...
static gboolean ___lambda6__gtk_widget_enter_notify_event (GtkWidget* _sender, GdkEventCrossing* event, gpointer self) {
	gboolean result;
	result = __lambda6_ ((IBusEmojierEListBox*) self, event);
	return result;
}
...
static IBusEmojierEListBox* ibus_emojier_elist_box_construct (GType object_type) {
	...
	g_signal_connect_object ((GtkWidget*) self, "motion-notify-event", (GCallback) ___lambda5__gtk_widget_motion_notify_event, self, 0);
	g_signal_connect_object ((GtkWidget*) self, "enter-notify-event", (GCallback) ___lambda6__gtk_widget_enter_notify_event, self, 0);
	return self;
}
