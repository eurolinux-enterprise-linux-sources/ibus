...
static void __lambda20_ (CandidateArea* self, GtkButton* b);
static void ___lambda20__gtk_button_clicked (GtkButton* _sender, gpointer self);
static void __lambda21_ (CandidateArea* self, GtkButton* b);
...
static void _vala_array_add3 (GtkLabel** * array, int* length, int* size, GtkLabel* value);
static gboolean ______lambda22_ (Block2Data* _data2_, GtkWidget* w, GdkEventButton* e);
static gboolean _______lambda22__gtk_widget_button_press_event (GtkWidget* _sender, GdkEventButton* event, gpointer self);
static void _vala_array_add4 (GtkWidget** * array, int* length, int* size, GtkWidget* value);
static gboolean ______lambda23_ (Block2Data* _data2_, GtkWidget* w, GdkEventButton* e);
static gboolean _______lambda23__gtk_widget_button_press_event (GtkWidget* _sender, GdkEventButton* event, gpointer self);
static void _vala_array_add5 (GtkWidget** * array, int* length, int* size, GtkWidget* value);
static Block3Data* block3_data_ref (Block3Data* _data3_);
static void block3_data_unref (void * _userdata_);
static void _vala_array_add6 (GtkLabel** * array, int* length, int* size, GtkLabel* value);
static void _vala_array_add7 (GtkLabel** * array, int* length, int* size, GtkLabel* value);
static gboolean ______lambda24_ (Block3Data* _data3_, GtkWidget* w, GdkEventButton* e);
static gboolean _______lambda24__gtk_widget_button_press_event (GtkWidget* _sender, GdkEventButton* event, gpointer self);
static void _vala_array_add8 (GtkWidget** * array, int* length, int* size, GtkWidget* value);
...
static void ___lambda20__gtk_button_clicked (GtkButton* _sender, gpointer self) {
	__lambda20_ ((CandidateArea*) self, _sender);
}
...
static void ___lambda21__gtk_button_clicked (GtkButton* _sender, gpointer self) {
	__lambda21_ ((CandidateArea*) self, _sender);
}
...
static gboolean _______lambda22__gtk_widget_button_press_event (GtkWidget* _sender, GdkEventButton* event, gpointer self) {
	gboolean result;
	result = ______lambda22_ (self, _sender, event);
	return result;
}
...
static gboolean _______lambda23__gtk_widget_button_press_event (GtkWidget* _sender, GdkEventButton* event, gpointer self) {
	gboolean result;
	result = ______lambda23_ (self, _sender, event);
	return result;
}
...
static gboolean _______lambda24__gtk_widget_button_press_event (GtkWidget* _sender, GdkEventButton* event, gpointer self) {
	gboolean result;
	result = ______lambda24_ (self, _sender, event);
	return result;
}
...
static void candidate_area_recreate_ui (CandidateArea* self) {
	...
	prev_button = _tmp3_;
	_tmp4_ = prev_button;
	g_signal_connect_object (_tmp4_, "clicked", (GCallback) ___lambda20__gtk_button_clicked, self, 0);
	_tmp5_ = prev_button;
	...
	next_button = _tmp12_;
	_tmp13_ = next_button;
	g_signal_connect_object (_tmp13_, "clicked", (GCallback) ___lambda21__gtk_button_clicked, self, 0);
	_tmp14_ = next_button;
		...
		self->priv->_m_widgets_size_ = self->priv->m_widgets_length1;
		{
			...
			_data1_->i = 0;
			{
				...
				while (TRUE) {
					...
					_vala_array_add2 (&self->priv->m_labels, &self->priv->m_labels_length1, &self->priv->_m_labels_size_, _tmp71_);
					...
					_vala_array_add3 (&self->priv->m_candidates, &self->priv->m_candidates_length1, &self->priv->_m_candidates_size_, _tmp78_);
					_tmp79_ = label;
					...
					_tmp84_ = label_ebox;
					g_signal_connect_data ((GtkWidget*) _tmp84_, "button-press-event", (GCallback) _______lambda22__gtk_widget_button_press_event, block2_data_ref (_data2_), (GClosureNotify) block2_data_unref, 0);
					_tmp85_ = label_ebox;
					_tmp86_ = label;
					...
					g_signal_connect_data ((GtkWidget*) _tmp94_, "button-press-event", (GCallback) _______lambda23__gtk_widget_button_press_event, block2_data_ref (_data2_), (GClosureNotify) block2_data_unref, 0);
					...
					_vala_array_add5 (&self->priv->m_widgets, &self->priv->m_widgets_length1, &self->priv->_m_widgets_size_, _tmp101_);
		...
		self->priv->_m_widgets_size_ = self->priv->m_widgets_length1;
		{
			...
			i = 0;
			{
				...
				while (TRUE) {
					...
					_vala_array_add6 (&self->priv->m_labels, &self->priv->m_labels_length1, &self->priv->_m_labels_size_, _tmp123_);
					...
					_vala_array_add7 (&self->priv->m_candidates, &self->priv->m_candidates_length1, &self->priv->_m_candidates_size_, _tmp130_);
					...
					_tmp140_ = ebox;
					g_signal_connect_data ((GtkWidget*) _tmp140_, "button-press-event", (GCallback) _______lambda24__gtk_widget_button_press_event, block3_data_ref (_data3_), (GClosureNotify) block3_data_unref, 0);
					_tmp141_ = ebox;
					...
					_vala_array_add8 (&self->priv->m_widgets, &self->priv->m_widgets_length1, &self->priv->_m_widgets_size_, _tmp147_);
